  ...
  <section class="content">
    ...
    <div class="entry-meta chainletter-meta">
      ...
      <ul class="chainletter-links">
        ...
        <li class="booklet-link"><a href="<?php the_field('chainletter_booklet', $acg_id); ?>" target="_blank">View booklet &raquo;</a></li>
        <li><a href="<?php the_field('chainletter_intro', $acg_id); ?>" class="vimeo-link" target="_blank">Watch intro &raquo;</a></li>
